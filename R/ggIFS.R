...
theme_ifs <- function(base_size = 10, ...) {
  ...
  ggplot2::theme_bw() +
    theme(panel.border = element_blank(),
          ...
          axis.title.x = element_text(color = "black", size = base_size, margin = ggplot2::margin(6, 0, 0, 0)),
          axis.title.y = element_text(color = "black", size = base_size, margin = ggplot2::margin(0, 6, 0, 0)),
